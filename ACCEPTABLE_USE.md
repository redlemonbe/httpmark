# Acceptable Use Policy — httpmark

httpmark is an HTTP benchmarking tool. At full throttle it generates
tens of thousands of requests per second. Pointed at a server
you do not own, it is a denial-of-service weapon.

## Permitted use

- HTTP/HTTPS infrastructure you own or operate
- Systems for which you hold explicit **written** authorization
- Controlled academic or security research environments
- CI/CD performance gates on your own services and APIs

## Prohibited use

- Any system without prior written authorization from its owner
- Denial-of-service attacks or HTTP flood attacks
...
*httpmark is designed to benchmark HTTP servers and APIs such as
[RunNginx](https://github.com/redlemonbe/RunNginx) in authorized environments.*
